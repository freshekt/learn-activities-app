...
activityPlacesService.searchResult$ = new BehaviorSubject(mockPlaceData);
activityPlacesService.provider$ = new BehaviorSubject<google.maps.places.PlacesService>(null);

export const placeAddSpy =  activityPlacesService.add$.and.returnValue(of(mockPlaceData[0]));

export const placeGetSpy = activityPlacesService.get$.and.returnValue(of(mockPlaceData[0]));
...
export const placeSearchSpy = activityPlacesService.search$.and.returnValue(of(mockPlaceData));
